...
// Saidas gravadas de um nginx real. Ficam num arquivo so porque sao dados, e
// porque o valor delas esta em nao serem inventadas: e a saida do nginx
// 1.20.1 empacotado pelo Oracle Linux 9, o mesmo host onde se mediu que
// `nginx -T` falha para o usuario comum.
const (
...
`
	...
	// Build do nginx.org, onde os caminhos sao relativos ao prefixo.
...
`
	...
	// O caso medido no host real: usuario comum nao le a configuracao.
